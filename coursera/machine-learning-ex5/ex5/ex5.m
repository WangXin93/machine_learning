...
fprintf('The error of test set is with lambda 3 is: %f\n',error);
...
lambda = 0.01;
[error_train, error_val] = ...
    learningCurveWithRandom(X_poly , y , X_poly_val , yval,lambda);

plot(1:m, error_train, 1:m, error_val);

title('Learning curve for poly-feature with randomly select examples')
legend('Train', 'Cross Validation')
xlabel('Number of training examples')
ylabel('Error')
axis([0 13 0 150])
